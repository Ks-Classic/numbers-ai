...
1000回分のデータで軸数字予測モデル（N3/N4）を学習します。
"""
...
# 評価結果も保存
eval_results_file = MODELS_DIR / 'evaluation_results_axis.pkl'
...
print(f"\n✅ すべての軸数字予測モデルを保存しました: {MODELS_DIR}")
...
results_df = pd.DataFrame(axis_evaluation_results)
print("\n評価指標の一覧:")
